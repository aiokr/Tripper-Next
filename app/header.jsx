...
export default function Header() { // 必须以大写开头
  ...
  return (
    <div className={`${currentPageStyle.header} ${headerStyle.header} bg-[#ffffff55] dark:text-white dark:bg-[#161617cc]`}>
      <div className='container grid grid-cols-1 md:grid-cols-3'>
        ...
        <div className='flex justify-center'>
          ...
          <Link className='' scroll={false} href="/photo">Photography</Link>
