...
export default async function AboutPage() {
  return (
    <main className='dark:dark:bg-zinc-900'>
      <div className='container px-4 lg:px-2 max-w-[1000px] grid grid-cols-12 grid-rows-8 gap-4 pt-[65px]'>
        <div className={`${style['aboutCard']} relative row-span-4 col-span-6 px-6 py-4 lg:px-10 lg:py-8 bg-main`}>
        ...
        <div className={`${style['aboutCard']} row-span-4 col-span-6 px-6 py-4 lg:px-10 lg:py-8 border`}>
        ...
        <div className={`${style['aboutCard']} relative row-span-4 col-span-6 px-6 py-4 lg:px-10 lg:py-8 text-white bg-gradient-to-br from-[#71DEF5] to-[#7199F5]`}>
