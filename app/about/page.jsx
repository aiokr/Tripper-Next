    ...
    <main className="bg-slate-50">
      <div className='container px-4 lg:px-0 max-w-[1000px] grid grid-cols-12 grid-rows-4 gap-4 pt-[65px]'>
        ...
        <div className={`${style['aboutCard']} row-span-2 col-span-6 p-4 lg:p-8 bg-white`}>
          ...
          <div className='py-1 lg:py-4'>
            <span className='text-lg leading-6 lg:leading-[3rem] lg:text-3xl font-[500] mr-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-300 to-blue-500'>Always as a Student</span><br />
            <span className='text-lg leading-6 lg:leading-[3rem] lg:text-3xl font-[500] mr-2 bg-clip-text text-transparent bg-gradient-to-r from-indigo-300 to-indigo-500'>Photographer</span><br />
      ...
      <div className='container px-4 lg:px-0 max-w-[1000px] grid grid-cols-12 pt-4'>
        <div className={`${style['aboutCard']} flex justify-between items-center row-span-2 col-span-12 p-4 lg:p-8 bg-white`}>
          ...
          <div className='grid grid-cols-2 lg:grid-cols-5 gap-3 lg:gap-5'>
            ...
            <a href='https://sspai.com/u/aiokr/posts' target='blank' className={`${style['aboutLink']} flex justify-center items-center  drop-shadow-lg shadow-red-300 bg-gradient-to-br from-[#fc281a] to-[#d7161c]`}>
              <svg viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" width="22" height="22" class="fill-white"><path d="m.67 6.186.105-1.51a.903.903 0 0 1 .754-.828L20.015.807a.811.811 0 0 1 .94.866l-.118 1.449a1 1 0 0 1-.828.904l-3.186.543v9.358a4 4 0 0 0 .44 1.824L19.08 19.3c.103.201.157.424.157.65v.194a.583.583 0 0 1-.584.584h-1.089a2.328 2.328 0 0 1-2.057-1.238l-1.732-3.27a4 4 0 0 1-.466-1.872V5.242l-4.829.898V18.19a2 2 0 0 1-.755 1.566l-.947.753a1 1 0 0 1-.623.217h-.21a.758.758 0 0 1-.758-.758V6.59l-3.33.648A1 1 0 0 1 .669 6.186Z"></path></svg>
            </a>
            <a href='https://500px.com.cn/aiokr' target='blank' className={`${style['aboutLink']} flex justify-center items-center  drop-shadow-lg shadow-slate-300 bg-gradient-to-br from-blue-400 to-blue-600`} >
      ...
      <div className='container px-4 lg:px-0 max-w-[1000px] grid grid-cols-12 pt-4'>
        <div className={`${style['aboutCard']} col-span-12 p-4 lg:p-8 bg-gradient-to-br from-green-200 to-blue-500`}>
          <div className='text-xl lg:text-3xl font-[500] leading-[60px] text-white'>🧑‍💻 My Friends</div>
          <div className='py-4 text-white grid grid-cols-2 lg:grid-cols-4'>
            {friends.map((friends) => (
              <a key={friends.title} href={`${friends.url}`} target='blank'>
                {friends.title}
              </a>
            ))}
          </div>
